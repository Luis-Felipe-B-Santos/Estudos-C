...
int main (void) 
{ 
int AU1, AU2, AU3, AU4, AU5, CI1, CI2, CI3, CI4, CI5, VI1, VI2, VI3, VI4, VI5, DI1, DI2, DI3, DI4, DI5, TOTVI, TOTDI, TOTAU, TOTCI;
	...
	if (op == '1'){
			...
			system ("pause");
				...
				system ("pause");
					...
					{
					TOTAU = 2 * (AU1 + AU2 + AU3 + AU4 + AU5);
					TOTDI = 2 * (DI1 + DI2 + DI3 + DI4 + DI5);
					TOTVI = 2 * (VI1 + VI2 + VI3 + VI4 + VI5);
					TOTCI = 2 * (CI1 + CI2 + CI3 + CI4 + CI5);
					}
					system ("pause");
					...
					fprintf (ponteiro, "As cinestesicas aprendem melhor por meio das sensacoes tateis, como o tato, a temperatura, a umidade, as sensacoes internas e as emocoes.\n");
...
FILE *ponteiro2;
		...
		fprintf (ponteiro2, "==================== PERFIL REPRESENTACIONAL DE %s ====================\n", NOME);
		fprintf (ponteiro2, "%i Visual    %i Auditivo    %i Cinestesico     %i Digital\n", TOTVI, TOTAU, TOTCI, TOTDI);
		fprintf (ponteiro2, "=======================================================================\n");
		fprintf (ponteiro2, "\n");
		fprintf (ponteiro2, "Algumas pessoas captam melhor as mensagens do mundo exterior atraves da audicao, sao as pessoas chamadas auditivas.\n");
		fprintf (ponteiro2, "Outras pessoas sentem necessidade de perguntar muito, necessitam de muitas informacoes e fatos. Estas sao as digitais.\n");
		fprintf (ponteiro2, "As cinestesicas aprendem melhor por meio das sensacoes tateis, como o tato, a temperatura, a umidade, as sensacpes internas e as emocoes.\n");
		fprintf (ponteiro2, "Ja as pessoas visuais aprendem melhor quando se valendo da visao.\n\n");
		fprintf (ponteiro2, "=======================================================================\n");
		if (TOTAU > TOTVI && TOTAU > TOTCI && TOTAU > TOTDI){
		fprintf (ponteiro2, "Seu perfil e AUDITIVO\n");
		fprintf (ponteiro2, "=======================================================================\n");}
		else if (TOTVI > TOTAU && TOTVI > TOTCI && TOTVI > TOTDI){
		fprintf (ponteiro2, "Seu perfil e VISUAL\n");
		fprintf (ponteiro2, "=======================================================================\n");}	
		else if (TOTDI > TOTAU && TOTDI > TOTVI && TOTDI > TOTCI){
		fprintf (ponteiro2, "Seu perfil e DIGITAL\n");
		fprintf (ponteiro2, "=======================================================================\n");}
		else{
		fprintf (ponteiro2, "Seu perfil e CINESTESICO\n");
		fprintf (ponteiro2, "=======================================================================\n");}
		fclose (ponteiro2);
		FILE* ponteiro3;
